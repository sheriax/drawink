...
Options:
    ...
    --idle-timeout <min>   Idle timeout in minutes (default: 20)
...
Testboxes automatically shut down after being idle (default: 20 minutes).
If you need a longer session, increase the timeout at warmup time:

    blacksmith testbox warmup blacksmith-testbox.yml --idle-timeout 30
