...
| **Region** | `asia-south1` |
| **Custom Domain** | `drawink.sheriax.com` |
...
```bash
# Check A record
dig drawink.sheriax.com A +short

# Check via Google DNS
dig @8.8.8.8 drawink.sheriax.com A +short
```
...
curl https://drawink.sheriax.com/health

# Test main app
curl -I https://drawink.sheriax.com/
```
...
| Environment | URL |
|-------------|-----|
| **Production (Custom Domain)** | https://drawink.sheriax.com |
