...
export interface AppState {
   ...
   */
  multiElement: NonDeleted<DrawinkLinearElement> | null;
  /**
   * decoupled from newElement, dragging selection only creates selectionElement
   * - set on pointer down, updated during pointer move
   */
  selectionElement: NonDeletedDrawinkElement | null;
  isBindingEnabled: boolean;
  startBoundElement: NonDeleted<DrawinkBindableElement> | null;
  suggestedBinding: NonDeleted<DrawinkBindableElement> | null;
  frameToHighlight: NonDeleted<DrawinkFrameLikeElement> | null;
  frameRendering: {
    enabled: boolean;
    name: boolean;
    outline: boolean;
  ...
  elementsToHighlight: NonDeleted<DrawinkElement>[] | null;
  /**
   * set when a new text is created or when an existing text is being edited
   */
  editingTextElement: NonDeletedDrawinkElement | null;
  activeTool: {
    /**
  ...
  currentItemFillStyle: DrawinkElement["fillStyle"];
  currentItemStrokeWidth: number;
  currentItemStrokeStyle: DrawinkElement["strokeStyle"];
  ...
  /** image cropping */
  isCropping: boolean;
  croppingElementId: DrawinkElement["id"] | null;

  /** null if no search matches found / search closed */
  searchMatches: Readonly<{
    focusedId: DrawinkElement["id"] | null;
...
export type LibraryItem_v1 = readonly NonDeleted<DrawinkElement>[];
/** @deprecated legacy: do not use outside of migration paths */
...
export type DrawinkInitialDataState = Merge<
  ImportedDataState,
  {
...
export type PointerDownState = Readonly<{
  ...
  originalElements: Map<string, NonDeleted<DrawinkElement>>;
  resize: {
  ...
  hit: {
    ...
    // pointer down event
    element: NonDeleted<DrawinkElement> | null;
...
export type FrameNameBoundsCache = {
  ...
  _cache: Map<
    ...
    FrameNameBounds & {
      ...
      versionNonce: DrawinkFrameLikeElement["versionNonce"];
    }
  >;
};
...
export type { NullableGridSize } from "@/lib/types";

export type GenerateDiagramToCode = (props: {
  frame: DrawinkMagicFrameElement;
  children: readonly DrawinkElement[];
