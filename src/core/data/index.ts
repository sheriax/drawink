...
import { getElementsOverlappingFrame } from "@/lib/elements";
...
export type ExportedElements = readonly NonDeletedDrawinkElement[] & {
...
export const exportCanvas = async (
    ...
    if (type === "svg") {
      return fileSave(
        ...
        }),
        {
          ...
          name,
          extension: appState.exportEmbedScene ? "drawink.svg" : "svg",
  ...
  if (type === "png") {
    ...
    return fileSave(blob, {
      ...
      name,
      extension: appState.exportEmbedScene ? "drawink.png" : "png",
