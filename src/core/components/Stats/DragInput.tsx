...
import { EVENT, KEYS, cloneJSON } from "@/lib/common";
...
export type DragInputCallbackType<P extends StatsInputProperty, E = DrawinkElement> = (props: {
  ...
  setAppState: ReturnType<typeof useDrawinkSetAppState>;
}) => void;

export type DragFinishedCallbackType<E = DrawinkElement> = (props: {
  app: ReturnType<typeof useApp>;
  setAppState: ReturnType<typeof useDrawinkSetAppState>;
        ...
        onPointerDown={(event) => {
          if (inputRef.current && editable) {
            ...
            const onPointerUp = () => {
              ...
              document.body.classList.remove("drawink-cursor-resize");
