...
import { showSelectedShapeActions } from "@/lib/elements";
...
import { CompactShapeActions, SelectedShapeActions, ShapesSwitcher } from "./Actions";
...
interface LayerUIProps {
  ...
  renderTopLeftUI?: DrawinkProps["renderTopLeftUI"];
  renderTopRightUI?: DrawinkProps["renderTopRightUI"];
  renderCustomStats?: DrawinkProps["renderCustomStats"];
...
const LayerUI = ({
  ...
  const renderCanvasActions = () => (
    <div
      className={clsx("canvas-actions-wrapper", {
        "canvas-actions-wrapper--with-dashboard": isSignedIn,
      })}
