...
const LayerUI = ({
  ...
  const renderCanvasActions = () => (
    <div className={clsx("canvas-actions-wrapper", { "canvas-actions-wrapper--with-dashboard": isSignedIn })} style={{ position: "relative", display: "flex", gap: "4px", alignItems: "center" }}>
