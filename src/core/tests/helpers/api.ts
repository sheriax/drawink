...
import { isLinearElementType } from "@/lib/elements";
...
export class API {
  ...
  static setElements = (elements: readonly DrawinkElement[]) => {
    act(() => {
      h.elements = elements;
    });
  };

  static setSelectedElements = (elements: DrawinkElement[], editingGroupId?: string | null) => {
    act(() => {
      h.setState({
  ...
  static updateElement = <T extends DrawinkElement>(
  ...
  static createElement = <T extends Exclude<DrawinkElementType, "selection"> = "rectangle">({
    ...
    id?: string;
    isDeleted?: boolean;
    frameId?: DrawinkElement["id"] | null;
    index?: DrawinkElement["index"];
    groupIds?: DrawinkElement["groupIds"];
    // generic element props
    strokeColor?: DrawinkGenericElement["strokeColor"];
    backgroundColor?: DrawinkGenericElement["backgroundColor"];
    fillStyle?: DrawinkGenericElement["fillStyle"];
    strokeWidth?: DrawinkGenericElement["strokeWidth"];
    strokeStyle?: DrawinkGenericElement["strokeStyle"];
    roundness?: DrawinkGenericElement["roundness"];
    roughness?: DrawinkGenericElement["roughness"];
    opacity?: DrawinkGenericElement["opacity"];
    // text props
    text?: T extends "text" ? DrawinkTextElement["text"] : never;
