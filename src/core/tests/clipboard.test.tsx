...
import { KEYS, arrayToMap, getLineHeight } from "@/lib/common";

import { getElementBounds } from "@/lib/elements";
...
vi.mock("@drawink/common", async (importOriginal) => {
...
describe("Paste bound text container", () => {
  ...
  const textElement = {
    ...
    originalText:
      "Drawink is a virtual opensource whiteboard for sketching hand-drawn like diagrams",
  };
