...
import { newElement } from "@/lib/elements";
...
export const actionBindText = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    if (
      ...
      textElement = selectedElements[1] as DrawinkTextElement;
      container = selectedElements[0] as DrawinkTextContainer;
    }
...
export const actionWrapTextInContainer = register({
  ...
  perform: (elements, appState, _, app) => {
    const selectedElements = app.scene.getSelectedElements(appState);
    let updatedElements: readonly DrawinkElement[] = elements.slice();
