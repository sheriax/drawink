...
const renderElementsBoxHighlight = (
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
  elements: NonDeleted<DrawinkElement>[],
...
const renderTextBox = (
  text: NonDeleted<DrawinkTextElement>,
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
...
const _renderInteractiveScene = ({
  ...
  visibleElements.forEach((element) => {
    ...
    if (
      ...
      if (element) {
        editingLinearElement = element as NonDeleted<DrawinkLinearElement>;
      }
    }
  });
  ...
  if (
    ...
    renderLinearPointHandles(
      context,
      appState,
      selectedElements[0] as NonDeleted<DrawinkLinearElement>,
      elementsMap,
    );
  }
  ...
  if (
    ...
    if (
      ...
      renderLinearPointHandles(
        context,
        appState,
        selectedElements[0] as DrawinkLinearElement,
        elementsMap,
      );
    }
