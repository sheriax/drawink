import type { UserIdleState, EditorInterface } from "@drawink/common";
import type {
  DrawinkElement,
...
export type StaticCanvasRenderConfig = {
  ...
  pendingFlowchartNodes: PendingDrawinkElements | null;
};
...
export type InteractiveCanvasRenderConfig = {
  ...
  // ---------------------------------------------------------------------------
  remoteSelectedElementIds: Map<DrawinkElement["id"], SocketId[]>;
...
export type StaticSceneRenderConfig = {
  ...
  visibleElements: readonly NonDeletedDrawinkElement[];
  scale: number;
...
export type NewElementSceneRenderConfig = {
  canvas: HTMLCanvasElement | null;
  rc: RoughCanvas;
  newElement: DrawinkElement | null;
  elementsMap: RenderableElementsMap;
  allElementsMap: NonDeletedSceneElementsMap;
  scale: number;
  appState: AppState;
