...
import { KEYS, randomId, arrayToMap } from "@drawink/common";
...
const allElementsInSameGroup = (elements: readonly DrawinkElement[]) => {
...
export const actionGroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const lastGroupElementIndex = nextElements.lastIndexOf(
      lastElementInGroup as OrderedDrawinkElement,
    );
...
export const actionUngroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const boundTextElementIds: DrawinkTextElement["id"][] = [];
    nextElements = nextElements.map((element) => {
