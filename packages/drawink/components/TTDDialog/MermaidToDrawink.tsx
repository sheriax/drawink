...
import type { MermaidToDrawinkLibProps } from "./common";
...
const MermaidToDrawink = ({
  ...
  }, [deferredText, mermaidToDrawinkLib]);
    ...
    <>
      ...
      <TTDDialogPanels>
        ...
        >
          <TTDDialogOutput
            canvasRef={canvasRef}
            loaded={mermaidToDrawinkLib.loaded}
            error={error}
          />
        </TTDDialogPanel>
      </TTDDialogPanels>
...
export default MermaidToDrawink;
