...
const DrawinkActionManagerContext = React.createContext<ActionManager>(
  null!,
);
...
export const useDrawinkContainer = () =>
  useContext(DrawinkContainerContext);
export const useDrawinkElements = () =>
  useContext(DrawinkElementsContext);
export const useDrawinkAppState = () =>
  useContext(DrawinkAppStateContext);
...
class App extends React.Component<AppProps, AppState> {
      ...
      const elements = (
        data.programmaticAPI
          ? convertToDrawinkElements(
            data.elements as DrawinkElementSkeleton[],
          )
          : data.elements
  ...
  private handleCanvasDoubleClick = (
    ...
    if (selectedElements.length === 1 && isLinearElement(selectedElements[0])) {
      const selectedLinearElement: DrawinkLinearElement =
        selectedElements[0];
      if (
    ...
    return withBatchedUpdates((childEvent: PointerEvent) => {
      ...
      if (
        ...
        if (this.state.selectedLinearElement.elbowed) {
          ...
          if (element) {
            this.scene.mutateElement(
              element as DrawinkElbowArrowElement,
              {},
            );
          }
        }
