import { toIterable } from "@drawink/common";
 ...
 */
export const getSceneVersion = (elements: readonly DrawinkElement[]) =>
...
export const getVisibleElements = (elements: readonly DrawinkElement[]) =>
  elements.filter(
