...
Pull requests are welcome. For major changes, please [open an issue](https://github.com/drawink/drawink/issues/new) first to discuss what you would like to change.

We have a [roadmap](https://github.com/orgs/drawink/projects/3) which we strongly recommend to go through and check if something interests you.
...
>
> ```bash
> git remote add upstream https://github.com/drawink/drawink.git
> git fetch upstream
...
1. Go to https://codesandbox.io/p/github/drawink/drawink
...
To translate Drawink into other languages, please visit [our Crowdin page](https://crowdin.com/project/drawink). To add a new language, [open an issue](https://github.com/drawink/drawink/issues/new) so we can get things set up on our end first.
