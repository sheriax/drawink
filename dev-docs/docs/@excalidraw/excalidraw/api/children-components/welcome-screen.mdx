...
When the canvas is empty, Drawink can show a welcome _splash_ screen with a logo, a few quick action items, and hints explaining what some of the UI buttons do. Once the user picks a tool, or has created an element on the canvas, the welcome screen will disappear.
...
<img
  ...
  alt="Drawink logo: Sketch hand-drawn like diagrams."
/>
        ...
        <WelcomeScreen>
          <WelcomeScreen.Center>
            ...
            <WelcomeScreen.Center.Menu>
              <WelcomeScreen.Center.MenuItemLink href="https://github.com/drawink/drawink">
                Drawink GitHub
...
Use the `<WelcomeScreen.Center.Logo/>` to render a logo. By default it renders the Drawink logo and name. Supply `children` to customize.
...
- `<WelcomeScreen.Center.MenuItemLiveCollaborationTrigger/>` - intended to open the live collaboration dialog. Works similarly to [`<LiveCollaborationTrigger>`](/docs/@drawink/drawink/api/children-components/live-collaboration-trigger) and you must supply `onSelect()` handler to integrate with your collaboration implementation.
