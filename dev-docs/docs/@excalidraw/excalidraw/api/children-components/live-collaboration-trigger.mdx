...
If you implement live collaboration support and want to expose the same UI button as on [drawink.com](https://drawink.com), you can render the `<LiveCollaborationTrigger/>` component using the [renderTopRightUI](/docs/@drawink/drawink/api/props#rendertoprightui) prop.
