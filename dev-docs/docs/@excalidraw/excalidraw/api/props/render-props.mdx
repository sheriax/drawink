...
For example you can use this prop to render the size of the elements in the storage as do in [drawink.com](https://drawink.com).
...
<pre>
  (element: NonDeleted&lt;DrawinkEmbeddableElement&gt;, appState:{" "}
  <a href="https://github.com/drawink/drawink/blob/master/packages/drawink/types.ts#L95">
    AppState
  </a>
  ) => JSX.Element | null
...
| --- | --- | --- |
| `element` | `NonDeleted<DrawinkEmbeddableElement>` | The embeddable element to be rendered. |
