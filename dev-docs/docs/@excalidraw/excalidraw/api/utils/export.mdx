...
&#125;: <a href="https://github.com/drawink/drawink/blob/master/packages/utils/export.ts#L24">ExportOpts</a>
</pre>

| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `elements` | [Drawink Element []](https://github.com/drawink/drawink/blob/master/packages/drawink/element/types.ts#L114) |  | The elements to be exported to canvas. |
| `appState` | [AppState](https://github.com/drawink/drawink/blob/master/packages/drawink/packages/utils.ts#L23) | [Default App State](https://github.com/drawink/drawink/blob/master/packages/drawink/appState.ts#L17) | The app state of the scene. |
...
| `files` | [BinaryFiles](https://github.com/drawink/drawink/blob/master/packages/drawink/types.ts#L59) | _ | The files added to the scene. |
...
```js
import { exportToCanvas } from "@drawink/drawink";
```
...
<pre>
exportToBlob(<br/>&nbsp;
  opts: <a href="https://github.com/drawink/drawink/blob/master/packages/drawink/packages/utils.ts#L14">ExportOpts</a> & &#123;<br/>&nbsp;
  mimeType?: string,<br/>&nbsp;
  quality?: number,<br/>&nbsp;
  exportPadding?: number;<br/>
})
...
```js
import { exportToBlob } from "@drawink/drawink";
```
...
exportToSvg(&#123;<br/>&nbsp;
  ...
  appState:
    <a href="https://github.com/drawink/drawink/blob/master/packages/drawink/types.ts#L95"> AppState
    </a>,<br/>&nbsp;
  exportPadding: number,<br/>&nbsp;
  metadata: string,<br/>&nbsp;
  files:&nbsp;
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| elements | [Drawink Element []](https://github.com/drawink/drawink/blob/master/packages/drawink/element/types.ts#L114) |  | The elements to exported as `svg `|
| appState | [AppState](https://github.com/drawink/drawink/blob/master/packages/drawink/types.ts#L95) | [defaultAppState](https://github.com/drawink/drawink/blob/master/packages/drawink/appState.ts#L11) | The `appState` of the scene |
| exportPadding | number | 10 | The `padding` to be added on canvas |
| files | [BinaryFiles](https://github.com/drawink/drawink/blob/master/packages/drawink/types.ts#L64) | undefined | The `files` added to the scene. |
...
exportToClipboard(<br/>&nbsp;
  opts: <a href="https://github.com/drawink/drawink/blob/master/packages/drawink/packages/utils.ts#L21">ExportOpts</a> & &#123;<br/>&nbsp;
  mimeType?: string,<br/>&nbsp;
  quality?: number;<br/>&nbsp;
...
```js
import { exportToClipboard } from "@drawink/drawink";
```
