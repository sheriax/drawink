---
slug: /@drawink/excalidraw/api/utils
---

# Utils

These are pure Javascript functions exported from the @drawink/excalidraw [`@drawink/excalidraw`](https://npmjs.com/@drawink/excalidraw). If you want to export your drawings in different formats eg `png`, `svg` and more you can check out [Export Utilities](/docs/@drawink/excalidraw/API/utils/export). If you want to restore your drawings you can check out [Restore Utilities](/docs/@drawink/excalidraw/API/utils/restore).
...
```js
import { serializeAsJSON } from "@drawink/excalidraw";
```
...
```js
import { serializeLibraryAsJSON } from "@drawink/excalidraw";
```
...
```js
import { isInvisiblySmallElement } from "@drawink/excalidraw";
```
...
```js
import { loadFromBlob } from "@drawink/excalidraw";
...
```js
import { loadLibraryFromBlob } from "@drawink/excalidraw";
```
...
```js showLineNumbers
import { loadSceneOrLibraryFromBlob, MIME_TYPES } from "@drawink/excalidraw";
...
```js
import { getFreeDrawSvgPath } from "@drawink/excalidraw";
```
...
```js
import { isLinearElement } from "@drawink/excalidraw";
```
...
```js
import { getNonDeletedElements } from "@drawink/excalidraw";
```
...
```js
import { mergeLibraryItems } from "@drawink/excalidraw";
```
...
```js
import { parseLibraryTokensFromUrl } from "@drawink/excalidraw";
```
...
```js
import { useHandleLibrary } from "@drawink/excalidraw";
...
```js
import { getSceneVersion } from "@drawink/excalidraw";
```
...
```js
import { sceneCoordsToViewportCoords } from "@drawink/excalidraw";
```
...
```js
import { viewportCoordsToSceneCoords } from "@drawink/excalidraw";
```
...
```js
import { defaultLang, languages, useI18n } from "@drawink/excalidraw";
```
...
List of supported language codes. You can pass any of these to `Excalidraw`'s [`langCode` prop](/docs/@drawink/excalidraw/api/props/#langcode).
...
```js
import { getCommonBounds } from "@drawink/excalidraw";
```
...
```js
import { elementsOverlappingBBox } from "@drawink/excalidraw";
```
...
```js
import { isElementInsideBBox } from "@drawink/excalidraw";
```
...
```js
import { elementPartiallyOverlapsWithOrContainsBBox } from "@drawink/excalidraw";
```
