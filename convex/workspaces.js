...
export const getById = query({
    ...
    handler: async (ctx, args) => {
        ...
        const hasAccess = workspace.ownerId === identity.subject ||
            (await ctx.db
                .query("workspaceMembers")
                .withIndex("by_workspace_and_user", (q) => q.eq("workspaceId", args.workspaceId).eq("userId", identity.subject))
                .first()) !== null;
        if (!hasAccess) {
...
export const update = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const member = await ctx.db
            .query("workspaceMembers")
            .withIndex("by_workspace_and_user", (q) => q.eq("workspaceId", workspaceId).eq("userId", identity.subject))
            .first();
