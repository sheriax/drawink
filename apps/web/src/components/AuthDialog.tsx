 ...
 * AuthDialog
 *
 * Dialog for authentication with Google and GitHub sign-in options.
  ...
  return (
    <Dialog size="small" onCloseRequest={handleClose} title={false}>
      <div className="AuthDialog">
        ...
        {error && <div className="AuthDialog__error">{error}</div>}
        ...
        <div className="AuthDialog__buttons">
          <FilledButton
            ...
            className="AuthDialog__button AuthDialog__button--google"
          />
          <FilledButton
            size="large"
            label={isLoading ? "Signing in..." : "Continue with GitHub"}
            icon={GithubIconColored}
            onClick={handleGithubLogin}
            status={isLoading ? "loading" : null}
            className="AuthDialog__button AuthDialog__button--github"
          />
        </div>
